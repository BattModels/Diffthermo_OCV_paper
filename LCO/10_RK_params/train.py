...
# # restart from 8000 epoch
# G0_start = -406488.1562   
# Omega0_start = -115015.5312
# Omega1_start = -29278.5820
# Omega2_start = -31574.6738 
# Omega3_start = -23044.0977
# Omega4_start = -42850.7852 
# Omega5_start = -114537.3594
# Omega6_start = -57312.5156 
# Omega7_start = 2403.6899 
# Omega8_start = -19045.9062 
# Omega9_start = 125735.6797 
# Omega10_start = -219602.2969 

# restart from 16000 epoch
G0_start = -396300.4062  
Omega0_start = -100930.1953 
Omega1_start = -7531.8486 
Omega2_start = -22281.5137 
Omega3_start = -46506.5078 
Omega4_start = 76477.3281 
Omega5_start = 213412.5469 
Omega6_start = -723490.4375 
Omega7_start = -589116.5000 
Omega8_start = 1322491.7500 
Omega9_start = 554844.1875 
Omega10_start = -982268.4375
...
params_list = [Omega0, Omega1, Omega2, Omega3, Omega4, Omega5, Omega6, Omega7, Omega8, Omega9, Omega10, G0] 

# init optimizer
learning_rate = 1000.0
params_list_for_optimizer = [Omega0, Omega1, Omega2, Omega3, Omega4, Omega5, Omega6, Omega7, Omega8, Omega9, Omega10, G0] 
...
epoch = -1
while loss > 0.0001 and epoch < 20000:
    # clean grad info
    optimizer.zero_grad()
    ...
    sample = sampling(GibbsFE, params_list, T=300, ngrid=249, sampling_id=1)
    # give the initial guess of miscibility gap
    phase_boundarys_init, _ = convex_hull(sample, ngrid=249)  
