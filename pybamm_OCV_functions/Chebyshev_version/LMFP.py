...
def fitted_OCP(sto):
    _eps = 1e-7
    # rk params
    G0 = -289885.312500 # G0 is the pure substance gibbs free energy 
    Omega0 = -409121.500000 
    Omega1 = 530060.062500 
    Omega2 = -362089.375000 
    Omega3 = 240680.484375 
    Omega4 = -146523.734375 
    Omega5 = 79514.593750 
    Omega6 = -42543.718750 
    Omega7 = 18622.531250 
    Omega8 = -6374.429199 
    ...
    # phase boundary 0
    x_alpha_0 = 0.4692888855934143
    x_beta_0 = 0.7079570293426514
    mu_coex_0 = -332351.9062500000000000
    is_outside_miscibility_gap_0 = (sto<x_alpha_0) + (sto>x_beta_0)
    # phase boundary 1
    x_alpha_1 = 0.7522515654563904
    x_beta_1 = 0.8745940327644348
    mu_coex_1 = -322364.3125000000000000
    is_outside_miscibility_gap_1 = (sto<x_alpha_1) + (sto>x_beta_1)
    # phase boundary 2
    x_alpha_2 = 0.0253316536545753
    x_beta_2 = 0.1149772703647614
    mu_coex_2 = -387946.9687500000000000
