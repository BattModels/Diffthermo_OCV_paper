...
def fitted_OCP(sto):
    _eps = 1e-7
    # rk params
    G0 = -336671.031250 # G0 is the pure substance gibbs free energy 
    Omega0 = -17259.064453 
    Omega1 = -61316.691406 
    Omega2 = -145472.875000 
    Omega3 = -41067.324219 
    Omegas =[Omega0, Omega1, Omega2, Omega3]
    # phase boundary 0
    x_alpha_0 = 0.0811685323715210
    x_beta_0 = 0.9259613156318665
    mu_coex_0 = -328734.9062500000000000
