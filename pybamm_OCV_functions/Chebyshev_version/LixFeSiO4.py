...
def fitted_OCP(sto):
    _eps = 1e-7
    # rk params
    G0 = -326511.843750 # G0 is the pure substance gibbs free energy 
    Omega0 = -107886.187500 
    Omega1 = -49832.609375 
    Omega2 = 10247.612305 
    Omega3 = 49614.269531 
    Omega4 = 10645.791992 
    ...
    x_beta_0 = 0.1225388869643211
    mu_coex_0 = -509023.2187500000000000
    is_outside_miscibility_gap_0 = (sto<x_alpha_0) + (sto>x_beta_0)
    # phase boundary 1
    x_alpha_1 = 0.5501978397369385
    x_beta_1 = 0.9732630252838135
    mu_coex_1 = -270524.2812500000000000
