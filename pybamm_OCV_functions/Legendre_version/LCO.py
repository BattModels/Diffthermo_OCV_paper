...
def fitted_OCP(sto):
    _eps = 1e-7
    # rk params
    G0 = -385251.750000 # G0 is the pure substance gibbs free energy 
    Omega0 = -80378.984375 
    Omega1 = 64631.609375 
    Omega2 = -40092.617188 
    Omega3 = 77520.875000 
    ...
    x_beta_0 = 0.1732864975929260
    mu_coex_0 = -439487.1250000000000000
    is_outside_miscibility_gap_0 = (sto<x_alpha_0) + (sto>x_beta_0)
    # phase boundary 1
    x_alpha_1 = 0.6889534592628479
    x_beta_1 = 0.9381049871444702
    mu_coex_1 = -355453.5000000000000000
