...
filenames = ["NMC_25degC_Co20.csv", "NMC_25degC_Co2.csv", "NMC_25degC_1C.csv", "NMC_25degC_2C.csv"]
...
plt.savefig('Figure5_raw.png', dpi=200, bbox_inches='tight') 
plt.close()
...
plt.savefig('Figure5_with_error.png', dpi=200, bbox_inches='tight') 
plt.close()


# plot the RNSE VS C_rate
# # rmse with customized OCV: [17.700, 25.888, 28.223, 36.780]
# # rmse with original OCV from About Energy: [15.911, 12.337, 13.411, 24.688]
import matplotlib as mpl  
mpl.rc('font',family='Arial')
...
plt.xlim([0.0,2.26])
plt.savefig('Figure5_rmse.png', dpi=200, bbox_inches='tight') 
plt.close()
