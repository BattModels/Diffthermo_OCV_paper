...
Omega6_start = np.random.randint(-100,100)*100
Omega7_start = np.random.randint(-100,100)*100
Omega8_start = np.random.randint(-100,100)*100
Omega9_start = np.random.randint(-100,100)*100
Omega10_start = np.random.randint(-100,100)*100
Omega11_start = np.random.randint(-100,100)*100
Omega12_start = np.random.randint(-100,100)*100
Omega13_start = np.random.randint(-100,100)*100
Omega14_start = np.random.randint(-100,100)*100
Omega15_start = np.random.randint(-100,100)*100
Omega16_start = np.random.randint(-100,100)*100
Omega17_start = np.random.randint(-100,100)*100
Omega18_start = np.random.randint(-100,100)*100
Omega19_start = np.random.randint(-100,100)*100
Omega20_start = np.random.randint(-100,100)*100
Omega21_start = np.random.randint(-100,100)*100
Omega22_start = np.random.randint(-100,100)*100
Omega23_start = np.random.randint(-100,100)*100
Omega24_start = np.random.randint(-100,100)*100
...
Omega9 = nn.Parameter( torch.from_numpy(np.array([Omega9_start],dtype="float32")) ) 
Omega10 = nn.Parameter( torch.from_numpy(np.array([Omega10_start],dtype="float32")) ) 
Omega11 = nn.Parameter( torch.from_numpy(np.array([Omega11_start],dtype="float32")) ) 
Omega12 = nn.Parameter( torch.from_numpy(np.array([Omega12_start],dtype="float32")) ) 
Omega13 = nn.Parameter( torch.from_numpy(np.array([Omega13_start],dtype="float32")) ) 
Omega14 = nn.Parameter( torch.from_numpy(np.array([Omega14_start],dtype="float32")) ) 
Omega15 = nn.Parameter( torch.from_numpy(np.array([Omega15_start],dtype="float32")) ) 
Omega16 = nn.Parameter( torch.from_numpy(np.array([Omega16_start],dtype="float32")) ) 
Omega17 = nn.Parameter( torch.from_numpy(np.array([Omega17_start],dtype="float32")) ) 
Omega18 = nn.Parameter( torch.from_numpy(np.array([Omega18_start],dtype="float32")) ) 
Omega19 = nn.Parameter( torch.from_numpy(np.array([Omega19_start],dtype="float32")) ) 
Omega20 = nn.Parameter( torch.from_numpy(np.array([Omega20_start],dtype="float32")) ) 
Omega21 = nn.Parameter( torch.from_numpy(np.array([Omega21_start],dtype="float32")) ) 
Omega22 = nn.Parameter( torch.from_numpy(np.array([Omega22_start],dtype="float32")) ) 
Omega23 = nn.Parameter( torch.from_numpy(np.array([Omega23_start],dtype="float32")) ) 
Omega24 = nn.Parameter( torch.from_numpy(np.array([Omega24_start],dtype="float32")) ) 
# declare all params
# params_list = [Omega0, Omega1, Omega2, Omega3, G0] 
params_list = [Omega0, Omega1, Omega2, Omega3, Omega4, Omega5, Omega6, Omega7, Omega8, Omega9, Omega10, Omega11, Omega12, Omega13, Omega14, Omega15, Omega16, Omega17, Omega18, Omega19, Omega20, Omega21, Omega22, Omega23, Omega24, G0] 

# init optimizer
learning_rate = 1000.0
params_list_for_optimizer = [Omega0, Omega1, Omega2, Omega3, Omega4, Omega5, Omega6, Omega7, Omega8, Omega9, Omega10, Omega11, Omega12, Omega13, Omega14, Omega15, Omega16, Omega17, Omega18, Omega19, Omega20, Omega21, Omega22, Omega23, Omega24, G0] 
